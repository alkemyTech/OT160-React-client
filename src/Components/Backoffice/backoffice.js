                ...
                <div className='container'>
                    <div className='box-1'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/create-news">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-2'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/backoffice/activities">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-3'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/create-category">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-4'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/create-testimonials">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-5'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/backoffice/organization/edit">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-6'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/backoffice/slides">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-7'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/backoffice/users">Ir</Link>
                        </div>
                    </div>
                    ...
                    <div className='box-8'>
                        ...
                        <div className='buttons'>
                            <Link class="btn btn-primary" to="/create-member">Ir</Link>
                        </div>
                    </div>
                </div>
            </div>
